...
<body>
	...
	<section class="mini-banner">
		<div class="contenedor">
			<h1 class="title-ubicacion">Productos</h1>
		</div>
	...
	<!-- SECCION PRODUCTOS -->
	<section>
		<h1 class="titulo-section contenedor title2">Chocolates pensados para ti</h1>
		<p class="contenedor centrar-texto p-compra-pro-black">Cada producto es una caja con 12 unidades</p>
		
		<!-- Seccion lista de productos -->
		<div class="contenedor section-comprar">
	...
	<section>
		<h1 class="titulo-section contenedor title2">Otros</h1>
